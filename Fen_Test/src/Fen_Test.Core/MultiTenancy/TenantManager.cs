...
using Fen_Test.MultiTenancy.Demo;
...
namespace Fen_Test.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(Fen_TestConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
