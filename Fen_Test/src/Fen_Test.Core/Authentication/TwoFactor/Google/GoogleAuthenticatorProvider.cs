...
namespace Fen_Test.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : Fen_TestServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Fen_Test", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
