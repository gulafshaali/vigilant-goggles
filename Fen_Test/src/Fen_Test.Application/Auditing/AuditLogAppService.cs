...
using Fen_Test.Auditing.Exporting;
using Fen_Test.Authorization;
using Fen_Test.Authorization.Users;
using Fen_Test.Dto;
using EntityHistoryHelper = Fen_Test.EntityHistory.EntityHistoryHelper;

namespace Fen_Test.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : Fen_TestAppServiceBase, IAuditLogAppService
    {
