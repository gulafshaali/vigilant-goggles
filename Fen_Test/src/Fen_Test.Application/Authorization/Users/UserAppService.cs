...
namespace Fen_Test.Authorization.Users
{
    ...
    public class UserAppService : Fen_TestAppServiceBase, IUserAppService
    {
        ...
        public UserAppService(
            ...
            IRepository<OrganizationUnit, long> organizationUnitRepository, IUserRepository userRepository)
        {
        ...
        public List<string> GetAllUsers()
        {
            using (CurrentUnitOfWork.DisableFilter(AbpDataFilters.MayHaveTenant))
            {
                ...
                return data.Select(e=>e.UserName).ToList();
            }
        ...
        public async Task<List<GetFieldsFromServer>> GetUsersNames()
        {
           var data= await _userRepository.GetUserNames(1,5);
            return data;
        }
        public async Task<List<GetPagesFromServer>> GetPagesData()
        {
            var data = await _userRepository.GetPagesData(1, 5);
            return data;
        }

        public async Task<string> GetFieldsFromPageandFormId(long formId, long pageid)
        {
            var data = await _userRepository.GetFieldsDataFromPageAndFormId(formId, pageid);
            return data;
        }
    }
}
