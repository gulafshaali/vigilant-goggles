...
using Fen_Test.Migrations.Seed.Host;
...
namespace Fen_Test.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : Fen_TestAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<Fen_TestDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(Fen_TestConsts.ConnectionStringName).Value.ToString();
        }
