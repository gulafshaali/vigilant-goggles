...
using Fen_Test.Tenants.Dashboard.Dto;

namespace Fen_Test.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : Fen_TestAppServiceBase, ITenantDashboardAppService
    {
