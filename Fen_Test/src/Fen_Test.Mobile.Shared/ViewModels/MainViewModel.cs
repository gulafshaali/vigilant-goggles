...
using MvvmHelpers;
using Fen_Test.Authorization.Users.Profile;
using Fen_Test.Authorization.Users.Profile.Dto;
using Fen_Test.Commands;
...
using Fen_Test.Controls;
using Fen_Test.Extensions;
using Fen_Test.Localization;
using Fen_Test.UI;
using Fen_Test.UI.Assets;
using Fen_Test.Views;
using DependencyResolver = Fen_Test.Core.Dependency.DependencyResolver;
...
namespace Fen_Test.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Fen_Test";
