...
namespace Fen_Test.Web.Startup
{
    ...
    public class Fen_TestWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public Fen_TestWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(Fen_TestWebHostModule).GetAssembly());
        }
