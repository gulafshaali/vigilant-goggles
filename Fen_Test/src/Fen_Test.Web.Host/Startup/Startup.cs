...
namespace Fen_Test.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "Fen_Test API", Version = "v1" });
            ...
            return services.AddAbp<Fen_TestWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Fen_Test API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Fen_Test.Web.wwwroot.swagger.ui.index.html");
            }); //URL: /swagger
        }
    }
}
