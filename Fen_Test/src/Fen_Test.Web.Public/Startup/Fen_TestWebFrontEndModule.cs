...
namespace Fen_Test.Web.Public.Startup
{
    [DependsOn(
        typeof(Fen_TestWebCoreModule)
    )]
    public class Fen_TestWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public Fen_TestWebFrontEndModule(IHostingEnvironment env, Fen_TestEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(Fen_TestWebFrontEndModule).GetAssembly());
        }
    }
}
