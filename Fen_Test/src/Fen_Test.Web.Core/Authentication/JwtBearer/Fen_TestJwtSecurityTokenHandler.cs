...
namespace Fen_Test.Web.Authentication.JwtBearer
{
    public class Fen_TestJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public Fen_TestJwtSecurityTokenHandler()
        {
